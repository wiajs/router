...
const swc = require('@rollup/plugin-swc'); // 编译转换ES6语法
...
const name = '@wiajs/router'; // umd 模式下的全局变量名
...
module.exports = [
  // browser dev
  {
    file: dir('dist/router.cmn.js'), // cjs格式，后端打包，保留引用
    format: 'cjs',
    browser: false,
    external,
  },
  {
    file: dir('dist/router.esm.js'), // esm格式，后端打包，保留引用
    format: 'esm',
  ...
  {
    file: dir('dist/router.js'), // umd格式，es5语法，web直接加载，合并引用
    format: 'umd',
    browser: true,
    es5: true, // 兼容旧版本浏览器
